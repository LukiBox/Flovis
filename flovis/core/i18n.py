...
_PL: dict[str, str] = {
    ...
    # --- theme / control surfaces (suite upgrade) ---
    "Theme:": "Motyw:", "Dark": "Ciemny", "Light": "Jasny",
    "Control surfaces": "Powierzchnie sterowe",
    "Carried through to StructVis and SimVis - the simulator derives "
    "control power from this placement.":
        "Przenoszone do StructVis i SimVis - symulator wyznacza skutecznosc "
        "sterow z tego rozmieszczenia.",
    "Type": "Typ", "On surface": "Na powierzchni",
    "Span from": "Zasieg od", "Span to": "Zasieg do",
    "Chord fraction": "Ulamek cieciwy", "Throw [deg]": "Wychylenie [deg]",
    "Remove": "Usun",
    "Add control surface": "Dodaj powierzchnie sterowa",
    "Reset to defaults": "Przywroc domyslne",
    "controls": "stery",
    "aileron": "lotka", "elevator": "ster wysokosci",
    "rudder": "ster kierunku", "flap": "klapa", "elevon": "elevon",
    # --- STEP orientation / cancel (1.2.0) ---
    "Orientation": "Orientacja",
    "Auto-detect": "Wykryj automatycznie",
    "chord X, span Y": "cieciwa X, rozpietosc Y",
    "chord X, span Z": "cieciwa X, rozpietosc Z",
    "chord Y, span X": "cieciwa Y, rozpietosc X",
    "chord Y, span Z": "cieciwa Y, rozpietosc Z",
    "chord Z, span X": "cieciwa Z, rozpietosc X",
    "chord Z, span Y": "cieciwa Z, rozpietosc Y",
    "Wrong way up or sideways? Pick which CAD axes are chord and span - "
    "the analysis reruns instantly, no re-mesh.":
        "Model lezy bokiem albo do gory nogami? Wybierz, ktore osie CAD to "
        "cieciwa i rozpietosc - analiza przeliczy sie od razu, bez "
        "ponownego siatkowania.",
    "Fitting planform and mapping Cp...":
        "Dopasowanie obrysu i mapowanie Cp...",
    "Cancel (analysis running...)": "Anuluj (analiza w toku...)",
    "Cancelling...": "Anulowanie...",
    "Cancelled.": "Anulowano.",
    "Re-fitting with the new orientation...":
        "Ponowne dopasowanie w nowej orientacji...",
    "orientation": "orientacja",
}
_load()
